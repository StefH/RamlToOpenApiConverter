...
public partial class RamlConverter
{
    ...
    private IOpenApiSchema MapMediaTypeSchema(string value, OpenApiSpecVersion specVersion)
    {
        ...
        var referenceSchemas = value
            ...
            .Select(o => CreateOpenApiReferenceSchema(o.Trim(), false, "object"))
            .ToList();
    ...
    private static IOpenApiSchema CreateOpenApiReferenceSchema(string referenceId, bool nullable, string? type = null)
    {
